...
| <a id="opt-http3-allow0rtt" href="#opt-http3-allow0rtt" title="#opt-http3-allow0rtt">`http3.allow0rtt`</a> | Contols whether QUIC 0RTT handskahes are permitted. <br /> This defaults to false because enablement allows for the bypassing of IP allow-lists.                                                                                                                                                                                                                                                                                                                                                                                                           | false                       | No       |
