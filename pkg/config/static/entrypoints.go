...
type EntryPoint struct {
	...
	Tailnet          string                `description:"Accepts connections on the named tailnet from the static configuration, instead of on the host network." json:"tailnet,omitempty" toml:"tailnet,omitempty" yaml:"tailnet,omitempty" export:"true"`
	TailnetService   string                `description:"Accepts the named Tailscale Service's traffic on that tailnet, instead of traffic addressed to the node itself." json:"tailnetService,omitempty" toml:"tailnetService,omitempty" yaml:"tailnetService,omitempty" export:"true"`
	TailnetListeners []*TailnetListener    `description:"Additional listeners on tailnets, accepting for this entryPoint alongside its own address." json:"tailnetListeners,omitempty" toml:"tailnetListeners,omitempty" yaml:"tailnetListeners,omitempty" export:"true"`
