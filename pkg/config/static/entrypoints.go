...
type HTTP3Config struct {
	...
	Allow0RTT         bool `description:"Allow0RTT allows the application to decide if a 0-RTT connection attempt should be accepted." json:"allow0RTT,omitempty" toml:"allow0RTT,omitempty" yaml:"allow0RTT,omitempty" export:"true"`
